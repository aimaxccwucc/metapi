  ...
  it.each([
    {
      ...
      expectedSql: [
        ...
        'ALTER TABLE token_routes ADD COLUMN routing_strategy text DEFAULT \'stable_first\';',
    ...
    },
    {
      ...
      expectedSql: [
        ...
        'ALTER TABLE `token_routes` ADD COLUMN `routing_strategy` VARCHAR(32) NULL DEFAULT \'stable_first\'',
