  ...
  it.each([
    {
      ...
      expectedSql: [
        ...
        'ALTER TABLE "sites" ADD COLUMN "flaresolverr_url" TEXT',
    ...
    },
    {
      ...
      expectedSql: [
        ...
        'ALTER TABLE `sites` ADD COLUMN `health_reason` TEXT NULL',
        'ALTER TABLE `sites` ADD COLUMN `health_checked_at` DATETIME NULL',
        'ALTER TABLE `sites` ADD COLUMN `flaresolverr_url` TEXT NULL',
