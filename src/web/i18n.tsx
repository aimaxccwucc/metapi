...
const zhToEn: Record<string, string> = {
  ...
  '当前页面发生运行时错误，已阻止白板。可以重试当前页面，或先返回仪表盘继续使用。': 'A runtime error occurred on this page. Blank screen was prevented. You can retry this page or go back to the dashboard.',
  '未知错误': 'Unknown error',
  '重试当前页': 'Retry this page',
  '刷新页面': 'Reload page',
  ...
  '刷新路由决策': 'Refresh Route Decisions',
  '路由决策已刷新': 'Route decisions refreshed',
  '刷新路由决策失败': 'Failed to refresh route decisions',
  '自动重建': 'Auto Rebuild',
  ...
  '当前故障总览': 'Current Fault Overview',
  '站点惩罚': 'Site Penalty',
  '来源异常群组': 'Source Issue Groups',
  '故障摘要': 'Fault Summary',
  '来源故障摘要': 'Source Fault Summary',
  '运行时正常': 'Runtime Healthy',
  '当前无通道': 'No Active Channels',
  '数据库尚未就绪': 'Database Not Ready',
  '后台任务存在失败': 'Background Tasks Failed',
  '存在未读状态事件': 'Unread Status Events',
  '24 小时请求失败偏高': 'High 24h Failure Rate',
  '全局状态摘要': 'Global Status Summary',
  '后台失败': 'Task Failures',
  '未读事件': 'Unread Events',
  '24h 失败': '24h Failures',
  '个后台任务已失败，建议优先查看程序日志与任务详情。': ' background tasks failed. Check system logs and task details first.',
  '条未读状态事件待处理，可能包含失败告警或任务结果。': ' unread status events need attention and may include failure alerts or task results.',
  '次请求失败，失败率约 ': ' requests failed, with an approximate failure rate of ',
  '建议检查网关路由、站点健康和上游配额。': 'Check gateway routing, site health, and upstream quotas.',
